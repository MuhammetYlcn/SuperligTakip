...
public class SeasonDAO {
    ...
    //  READ BY ID: Sezon ID'sine göre tek bir sezon nesnesi getirir
    ...
    // CREATE: Sezonu manuel ID ile kaydetme (API'den gelen ID'yi korumak için)
    ...
    // READ ALL: Tüm sezonları getirir
    ...
    // UPDATE: Belirli bir ID'ye sahip sezonu günceller
