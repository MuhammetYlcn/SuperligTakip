...
public class PlayerDAO {
    ...
    // READ BY ID: TEXT'i Long'a çevirerek getir
    ...
    // CREATE: INSERT OR IGNORE yapısı
    ...
    // UPDATE: Manuel ID güncelleme mantığı
